...
function SponsorMail() {
  ...
  return (
    ...
    >
      <div class="container xl:px-16 mx-auto">
        <div class="-mx-4 flex flex-wrap lg:justify-between">
          <div class="w-full px-4 lg:w-1/2 ">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <div class="my-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-dark mb-1  font-bold">Our Location</h4>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-dark mb-1 text- font-bold">Phone Number</h4>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-dark mb-1 text- font-bold">Email Address</h4>
                  <p class="text-body-color text-base">
          ...
          <div class="w-full px-4 lg:w-1/2 :w-5/12">
            <div class="relative rounded-lg bg-black text-black p-8 shadow-lg sm:p-12">
              <form>
                <div class="mb-6">
                  <input
                    type="text"
