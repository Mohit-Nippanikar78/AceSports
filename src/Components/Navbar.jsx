  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <animated.div
            className="absolute w-4 h-4 duration-700 bg-white z-30  "
            style={props}
          ></animated.div>
          <div
            className="absolute z-40  top-1/2 w-4 h-4  left-1/2  	"
            style={{ transform: "translate(-50%,-50%)" }}
          >
            <img src={plusPng} className="cursor-pointer" />
          </div>
          <div
            className="absolute z-20  top-1/2 w-4 h-4  left-1/2  	"
          ...
          <motion.div
            ...
            animate="animate"
          >
            <img src={IconMenu} className="w-16" alt="" />
          </motion.div>
        </div>
      </div>
    </div>
